...
h3. Almost none of my work is tested well σ_σ. It shold be considered to be failing it's tests but I encourage you to fork this project and hack away. The majority of the work was not done by me. A tip of my hat to <a href="https://github.com/xaviershay">Xavier</a> and all the other Enki developers for their hard work.  

h2. 

A Ruby on Rails blogging app for the adventurous developer.
